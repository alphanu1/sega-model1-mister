...
# m1_main gained the coprocessor and the list controller after this list was
# written, and a missing module is a BUILD failure that reads as a test failure -
