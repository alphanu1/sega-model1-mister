...
int main(int argc, char** argv) {
    ...
    printf("test: THROUGHPUT - once per EMITTED QUAD, budget 94 cycles\n");
    {
        ...
        // in the same frame: 83 * 1.133 = 94. The unit costs 90 now, up from
        ...
        if (per > 94.0) { fails++; printf("  FAIL over the per-quad budget\n"); }
    }
