...
.PHONY: all lint test test_fp_mul test_fp_add test_alu test_agu test_seq test_fp_div test_regs test_mem area quartus quartus_list quartus_report clean distclean
...
test: test_fp_mul test_fp_add test_fp_div test_alu test_agu test_seq test_regs test_mem
...
AREA_MODULES := fp_mul fp_add fp_div mb86233_alu mb86233_agu mb86233_seq mb86233_regs mb86233_mem
...
clean:
	rm -rf obj_fpmul obj_fpadd obj_fpdiv obj_alu obj_agu obj_seq obj_regs obj_mem
